...
public class CloudController {
    ...
    @PostMapping("/file")
    void file(@RequestParam String filename, @RequestParam MultipartFile file, Authentication authentication) throws IOException {
    ...
    @GetMapping("/list")
    public List getList(@RequestParam int limit, Authentication authentication) {
    ...
    @GetMapping("/file")
    public Resource getFile(@RequestParam String filename, Authentication authentication) {
